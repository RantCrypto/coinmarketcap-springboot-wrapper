...
/**
 * <p>Service worker layer for {@link com.rantcrypto.cmc.api.controller.CryptocurrencyController }</p>
 * 
...
public class CryptocurrencyService extends CoinMarketCapService {
	...
	public ResponseEntity<String> getListingsHistorical(String date, Long start, Long limit, String convert, String convertId, String sort, String sortDir, String cryptocurrencyType, String aux) {
		...
		return super.getResponseFromEndpoint(CRYPTOCURRENCY_LISTINGS_HISTORICAL_ENDPOINT, paramMap);
	}
	...
	public ResponseEntity<String> getQuotesLatest(String id, String slug, String symbol, String convert, String convertId, String aux,
		...
		paramMap.put("convert_id", convertId);
		paramMap.put("aux", aux);
		paramMap.put("skip_invalid", (skipInvalid != null ? Boolean.toString(skipInvalid) : null));
		
		return super.getResponseFromEndpoint(CRYPTOCURRENCY_QUOTES_LATEST_ENDPOINT, paramMap);
	}
	...
	public ResponseEntity<String> getQuotesHistorical(String id, String symbol, String timeStart, String timeEnd, Long count,
		...
		return super.getResponseFromEndpoint(CRYPTOCURRENCY_QUOTES_HISTORICAL_ENDPOINT, paramMap);
	}
	...
	public ResponseEntity<String> getMarketPairsLatest(String id, String slug, String symbol, Long start, Long limit, String sortDir,
		...
		return super.getResponseFromEndpoint(CRYPTOCURRENCY_MARKET_PAIRS_LATEST_ENDPOINT, paramMap);
	}
	...
	public ResponseEntity<String> getOhlcvLatest(String id, String symbol, String convert, String convertId, Boolean skipInvalid) {
		...
		return super.getResponseFromEndpoint(CRYPTOCURRENCY_OHLCV_LATEST_ENDPOINT, paramMap);
	}
	...
	public ResponseEntity<String> getOhlcvHistorical(String id, String slug, String symbol, String timePeriod, String timeStart,
		...
		paramMap.put("slug", slug);
		paramMap.put("symbol", symbol);
		paramMap.put("time_period", timePeriod);
		paramMap.put("time_start", timeStart);
		paramMap.put("time_end", timeEnd);
		paramMap.put("count", (count != null ? Long.toString(count) : null));
		paramMap.put("interval", interval);
		...
		return super.getResponseFromEndpoint(CRYPTOCURRENCY_OHLCV_HISTORICAL_ENDPOINT, paramMap);
	}
	 ...
	 * @param convert Optionally calculate quotes in up to 120 currencies at once by passing a comma-separated list of cryptocurrency or fiat currency symbols. Each additional convert option beyond the first requires an additional call credit. A list of supported fiat options can be found here. Each conversion is returned in its own "quote" object.
	...
	public ResponseEntity<String> getPricePerformanceStatsLatest(String id, String slug, String symbol, String timePeriod,
		...
		return super.getResponseFromEndpoint(CRYPTOCURRENCY_PRICE_PERFORMANCE_STATS_LATEST_ENDPOINT, paramMap);
	}
}
